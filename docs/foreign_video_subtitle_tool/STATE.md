...
Implemented baseline v1 package under `foreign_video_subtitle_tool/` with CLI, pipeline stages, docs, examples, and tests.
...
- Unit tests for SRT, translation batching, resume/skip logic, doctor, FFmpeg command construction, and manual stop behavior.
